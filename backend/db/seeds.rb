...
r2 = Review.create({user_id: u1.id,username:Faker::Name.first_name  ,text:"Best Pet hotel ever. The people are awesome and kind and the facilities are clean and comfortable for my doggie.",image:"https://lh3.googleusercontent.com/proxy/bcLEyIQmri8jhwk2ZIPrCTYTlp27v4kd98Fu0iLNqhkbrqShDqGcSuNzbqbbFH4qbbo8_p7ozYs1u6s0EmTiAFDpMc7sH8Phlv_kn2W3IUrBmVV-vPQnwN8"})
...
r2 = Review.create({user_id: u3.id,username:Faker::Name.first_name  ,text:"Awesome staff, AMAZING facility (don't let the outside fool you).",image:"https://lh3.googleusercontent.com/proxy/MSaMlaQ14pT_QaS5arGusgsuRKkvVqpB3zIL-0lD5w_yZxLv7BSkNPQ5o4mfARxImeFI5QJAtKqbAiCPxVE0iztTDu_YtBgSM5LxFdNia-DakbLusODU0ETsSubJv_-k3A7gq0TMHH6UGVnnxVwYRQ"})
...
r2 = Review.create({user_id: u2.id,username:"Goku" ,text:"Will definitely be bringing my cats again here! She was taken care of and fed and when she was picked up I saw how well she was cared for!",image:"https://cdn.shopify.com/s/files/1/1465/0432/products/il_570xN.598707123_fvs5_grande.jpg?v=1472714653"})
r2 = Review.create({user_id: u2.id,username:"Taquirooo",text:"I travel for work, sometimes with a ton of warning and sometimes with no warning. No issues with me last minute boarding my cat. Staff is friendly. No issues when I call.",image:"https://www.maskerix.com/wp-content/uploads/2019/04/diy-taco-dog-costume.jpg"})