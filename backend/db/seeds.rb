...
b1 = Booking.create({user_id:u1.id, pet_id: p1.id,services:"platinum",client_notes:"awesome",fee:"10", location:"Downtown"})
b2 = Booking.create({user_id:u2.id,pet_id: p2.id,services:"gold",client_notes:"nahh",fee:"10",location:"Sugar Land"})
